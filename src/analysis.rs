...
pub struct OperationResponse {
    ...
    /// alternate SSE/binary/text transports for accurate client method planning.
    #[serde(skip)]
...
/// the generated client must identify each transport from the declared media
/// type, not infer its semantics from method-name suffixes such as `_stream`.
